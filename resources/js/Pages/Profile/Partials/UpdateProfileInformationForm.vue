            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="mt-2 text-sm text-[var(--app-text)]">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="rounded-md text-sm text-[var(--app-text-muted)] underline hover:text-[var(--app-text)] focus:outline-none focus:ring-2 focus:ring-[var(--app-primary)] focus:ring-offset-2"
                    >
